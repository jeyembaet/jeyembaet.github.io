...
<html lang="en"> 
 <head> 
  ...
  <title>San Pablo Tourism - Seven Lakes</title> <!-- Load Tailwind CSS via CDN --> 
  <script src="https://cdn.tailwindcss.com"></script> <!-- Load Lucide Icons --> 
  ...
  <style>
        ...
        #video-overlay {
            ...
            z-index: -1; /* Above the video but below the main content */
        }
        /* --- END VIDEO BACKGROUND STYLES --- */

        /* Utility for centering the Lucide icons */
        .icon-center {
            display: inline-flex;
            align-items: center;
 ...
 <body class="min-h-screen flex flex-col"> <!-- Video Background Container (New) --> 
  <div id="video-background-container"> <!-- 
            NOTE: This is a placeholder video URL. 
            For a real application, you must replace this with a video of a San Pablo lake 
            that you host securely (e.g., on a CDN).
        --> 
  ...
  <main id="main-content" class="pb-12 pt-4 flex-grow"> <!-- Content sections will be dynamically rendered here --> <!-- Home View --> 
   <section id="view-home" class="content-view max-w-7xl mx-auto hidden-view px-4"></section> <!-- Attractions View --> 
   <section id="view-attractions" class="content-view max-w-7xl mx-auto hidden-view px-4"></section> <!-- Attraction Detail View --> 
   <section id="view-detail" class="content-view max-w-4xl mx-auto hidden-view px-4"></section> <!-- Guides View --> 
   <section id="view-guides" class="content-view max-w-7xl mx-auto hidden-view px-4"></section> <!-- Map View --> 
   <section id="view-map" class="content-view max-w-7xl mx-auto hidden-view px-4"></section> <!-- Appointments View --> 
   <section id="view-appointments" class="content-view max-w-xl mx-auto hidden-view px-4"></section> 
  </main> <!-- Footer / Closing Bar --> 
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-8 border-b border-blue-700 pb-6"> <!-- Logo and Mission --> 
     ...
     <div> 
      ...
      <ul class="space-y-2 text-sm"> 
       ...
       <li><a href="#" onclick="App.navigate('attractions')" class="text-blue-200 hover:text-white transition-colors">Attractions</a></li> 
  ...
  </div> <!-- JavaScript Application Logic --> 
  <script>
        const NAV_PAGES = {
            HOME: 'home',
        ...
        const App = {
            ...
            renderStarRating: function(rating) {
                ...
                html += `<span class="text-sm font-semibold text-gray-700 ml-1">${rating}</span></div>`;
                return html;
            }
        };
